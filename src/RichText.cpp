...
////////////////////////////////////////////////////////////////////////////////
void RichText::Line::draw(sf::RenderTarget &target, const sf::RenderStates& states) const
{
    auto curStates = states;
    curStates.transform *= getTransform();

    for (const sf::Text &text : m_texts)
        target.draw(text, curStates);
}
...
////////////////////////////////////////////////////////////////////////////////
std::vector<sf::String> explode(const sf::String &string, char32_t delimiter) {
    if (string.isEmpty())
...
////////////////////////////////////////////////////////////////////////////////
void RichText::draw(sf::RenderTarget& target, const sf::RenderStates& states) const
{
    auto curStates = states;
    curStates.transform *= getTransform();

    for (const Line &line : m_lines)
        target.draw(line, curStates);
}
